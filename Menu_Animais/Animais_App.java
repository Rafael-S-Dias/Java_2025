        ...
        try {
            switch (opcao) {
                ...
                case 2:
                    ...
                    System.out.println("Nome: " + p.getNome() + "| Quantidade de patas: " + p.getQtds_patas()+ "| Raça: "+p.getRaca()+"\n");
                    
                    System.out.println("Gatos Cadastros: ");
                    for (Gato p:gatos)
                    System.out.println("Nome: " + p.getNome() + "| Quantidade de patas: " + p.getQtds_patas()+ "| Cor: "+p.getCor()+"\n");
                    
                    System.out.println("\nDigite o nome do animal que deseja ouvir o som: ");
